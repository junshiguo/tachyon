...
public class WorkerService {
  ...
  public interface Iface {
     ...
     * @param blockInfo
     */
    public boolean master_cacheFromRemote(long userId, ClientBlockInfo blockInfo) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void master_cacheFromRemote(long userId, ClientBlockInfo blockInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean master_cacheFromRemote(long userId, ClientBlockInfo blockInfo) throws org.apache.thrift.TException
    {
      send_master_cacheFromRemote(userId, blockInfo);
      return recv_master_cacheFromRemote();
    }

    public void send_master_cacheFromRemote(long userId, ClientBlockInfo blockInfo) throws org.apache.thrift.TException
    {
      master_cacheFromRemote_args args = new master_cacheFromRemote_args();
      args.setUserId(userId);
      args.setBlockInfo(blockInfo);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void master_cacheFromRemote(long userId, ClientBlockInfo blockInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      master_cacheFromRemote_call method_call = new master_cacheFromRemote_call(userId, blockInfo, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class master_cacheFromRemote_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long userId;
      private ClientBlockInfo blockInfo;
      public master_cacheFromRemote_call(long userId, ClientBlockInfo blockInfo, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class master_cacheFromRemote<I extends Iface> extends org.apache.thrift.ProcessFunction<I, master_cacheFromRemote_args> {
      ...
      public master_cacheFromRemote_result getResult(I iface, master_cacheFromRemote_args args) throws org.apache.thrift.TException {
        master_cacheFromRemote_result result = new master_cacheFromRemote_result();
        result.success = iface.master_cacheFromRemote(args.userId, args.blockInfo);
        result.setSuccessIsSet(true);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class master_cacheFromRemote<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, master_cacheFromRemote_args, Boolean> {
      ...
      public void start(I iface, master_cacheFromRemote_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException {
        iface.master_cacheFromRemote(args.userId, args.blockInfo,resultHandler);
      }
    }
...
;
  ...
  public static class master_cacheFromRemote_args implements org.apache.thrift.TBase<master_cacheFromRemote_args, master_cacheFromRemote_args._Fields>, java.io.Serializable, Cloneable, Comparable<master_cacheFromRemote_args>   {
    ...
    private static final org.apache.thrift.protocol.TField USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("userId", org.apache.thrift.protocol.TType.I64, (short)1);
    private static final org.apache.thrift.protocol.TField BLOCK_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("blockInfo", org.apache.thrift.protocol.TType.STRUCT, (short)2);
    ...
    public long userId; // required
    public ClientBlockInfo blockInfo; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      USER_ID((short)1, "userId"),
      BLOCK_INFO((short)2, "blockInfo");
    ...
    public master_cacheFromRemote_args(master_cacheFromRemote_args other) {
      ...
      if (other.isSetBlockInfo()) {
        this.blockInfo = new ClientBlockInfo(other.blockInfo);
      }
    }
    ...
    public ClientBlockInfo getBlockInfo() {
      return this.blockInfo;
    }

    public master_cacheFromRemote_args setBlockInfo(ClientBlockInfo blockInfo) {
      this.blockInfo = blockInfo;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case BLOCK_INFO:
        if (value == null) {
          ...
          setBlockInfo((ClientBlockInfo)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, master_cacheFromRemote_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // BLOCK_INFO
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.blockInfo = new ClientBlockInfo();
