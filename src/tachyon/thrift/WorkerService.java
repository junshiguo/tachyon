              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.blockInfos = new ArrayList<ClientBlockInfo>(_list206.size);
                  ClientBlockInfo _elem207;
                  for (int _i208 = 0; _i208 < _list206.size; ++_i208)
                  {
                    _elem207 = new ClientBlockInfo();
                    _elem207.read(iprot);
                    struct.blockInfos.add(_elem207);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, master_cacheFromRemote_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.blockInfos != null) {
          oprot.writeFieldBegin(BLOCK_INFOS_FIELD_DESC);
          {
            ...
            for (ClientBlockInfo _iter209 : struct.blockInfos)
            {
        ...
        if (struct.isSetBlockInfos()) {
          {
            ...
            for (ClientBlockInfo _iter210 : struct.blockInfos)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.blockInfos = new ArrayList<ClientBlockInfo>(_list211.size);
            ClientBlockInfo _elem212;
            for (int _i213 = 0; _i213 < _list211.size; ++_i213)
            {
              _elem212 = new ClientBlockInfo();
              _elem212.read(iprot);
              struct.blockInfos.add(_elem212);
            }
          }
          struct.setBlockInfosIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.blockIds = new ArrayList<Long>(_list214.size);
                  long _elem215;
                  for (int _i216 = 0; _i216 < _list214.size; ++_i216)
                  {
                    _elem215 = iprot.readI64();
                    struct.blockIds.add(_elem215);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, master_freeBlocks_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.blockIds != null) {
          oprot.writeFieldBegin(BLOCK_IDS_FIELD_DESC);
          {
            ...
            for (long _iter217 : struct.blockIds)
            {
        ...
        if (struct.isSetBlockIds()) {
          {
            ...
            for (long _iter218 : struct.blockIds)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.blockIds = new ArrayList<Long>(_list219.size);
            long _elem220;
            for (int _i221 = 0; _i221 < _list219.size; ++_i221)
            {
              _elem220 = iprot.readI64();
              struct.blockIds.add(_elem220);
            }
          }
          struct.setBlockIdsIsSet(true);
        }
