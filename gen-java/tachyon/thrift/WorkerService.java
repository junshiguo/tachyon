      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, master_cacheFromRemote_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.blockInfos != null) {
          oprot.writeFieldBegin(BLOCK_INFOS_FIELD_DESC);
          {
            ...
            for (ClientBlockInfo _iter177 : struct.blockInfos)
            {
        ...
        if (struct.isSetBlockInfos()) {
          {
            ...
            for (ClientBlockInfo _iter178 : struct.blockInfos)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.blockInfos = new ArrayList<ClientBlockInfo>(_list179.size);
            ClientBlockInfo _elem180;
            for (int _i181 = 0; _i181 < _list179.size; ++_i181)
            {
              _elem180 = new ClientBlockInfo();
              _elem180.read(iprot);
              struct.blockInfos.add(_elem180);
            }
          }
          struct.setBlockInfosIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.blockIds = new ArrayList<Long>(_list182.size);
                  long _elem183;
                  for (int _i184 = 0; _i184 < _list182.size; ++_i184)
                  {
                    _elem183 = iprot.readI64();
                    struct.blockIds.add(_elem183);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, master_freeBlocks_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.blockIds != null) {
          oprot.writeFieldBegin(BLOCK_IDS_FIELD_DESC);
          {
            ...
            for (long _iter185 : struct.blockIds)
            {
        ...
        if (struct.isSetBlockIds()) {
          {
            ...
            for (long _iter186 : struct.blockIds)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.blockIds = new ArrayList<Long>(_list187.size);
            long _elem188;
            for (int _i189 = 0; _i189 < _list187.size; ++_i189)
            {
              _elem188 = iprot.readI64();
              struct.blockIds.add(_elem188);
            }
          }
          struct.setBlockIdsIsSet(true);
        }
