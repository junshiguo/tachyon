              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.blockInfos = new ArrayList<ClientBlockInfo>(_list198.size);
                  ClientBlockInfo _elem199;
                  for (int _i200 = 0; _i200 < _list198.size; ++_i200)
                  {
                    _elem199 = new ClientBlockInfo();
                    _elem199.read(iprot);
                    struct.blockInfos.add(_elem199);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, master_cacheFromRemote_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.blockInfos != null) {
          oprot.writeFieldBegin(BLOCK_INFOS_FIELD_DESC);
          {
            ...
            for (ClientBlockInfo _iter201 : struct.blockInfos)
            {
        ...
        if (struct.isSetBlockInfos()) {
          {
            ...
            for (ClientBlockInfo _iter202 : struct.blockInfos)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.blockInfos = new ArrayList<ClientBlockInfo>(_list203.size);
            ClientBlockInfo _elem204;
            for (int _i205 = 0; _i205 < _list203.size; ++_i205)
            {
              _elem204 = new ClientBlockInfo();
              _elem204.read(iprot);
              struct.blockInfos.add(_elem204);
            }
          }
          struct.setBlockInfosIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.blockIds = new ArrayList<Long>(_list206.size);
                  long _elem207;
                  for (int _i208 = 0; _i208 < _list206.size; ++_i208)
                  {
                    _elem207 = iprot.readI64();
                    struct.blockIds.add(_elem207);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, master_freeBlocks_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.blockIds != null) {
          oprot.writeFieldBegin(BLOCK_IDS_FIELD_DESC);
          {
            ...
            for (long _iter209 : struct.blockIds)
            {
        ...
        if (struct.isSetBlockIds()) {
          {
            ...
            for (long _iter210 : struct.blockIds)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.blockIds = new ArrayList<Long>(_list211.size);
            long _elem212;
            for (int _i213 = 0; _i213 < _list211.size; ++_i213)
            {
              _elem212 = iprot.readI64();
              struct.blockIds.add(_elem212);
            }
          }
          struct.setBlockIdsIsSet(true);
        }
